...
#DIALOG: Tests with "dialog" for the menu.
...
WIDTH=60
CHOICE_HEIGHT=5
BACKTITLE="Tonton Jo - 2020 - https://www.youtube.com/channel/UCnED3K6K5FDUp-x_8rwpsZw"
TITLE="ez_proxmox_mail_configurator $varversion "
MENU="Choose one of the following options: "

OPTIONS=(1 "Configure"
         2 "Test"
         3 "Check logs for error - attempt to correct"
